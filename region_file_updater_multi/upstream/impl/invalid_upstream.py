...
from typing import TYPE_CHECKING, Optional, Type, Any, Tuple, Iterable
...
class InvalidUpstream(AbstractUpstream):
    ...
    def get_error_message(self):
        return f'[{self.__exc.__class__.__name__}] {str(self.__exc)}' or self.__rfum.rtr('error_message.unexpected')
